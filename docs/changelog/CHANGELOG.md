...
* FEATURE: [vmui](https://docs.victoriametrics.com/#vmui): show hidden common labels in the group name. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8031)
